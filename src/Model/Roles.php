...
class Roles extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('api.database.roles_table'));
    ...
    public function administrators() : BelongsToMany
    {
        ...
        $relatedModel = config('api.database.users_model');
    ...
    {
        $pivotTable = config('api.database.role_permissions_table');
    ...
    {
        $pivotTable = config('api.database.role_menu_table');

        $relatedModel = config('api.database.menu_model');
